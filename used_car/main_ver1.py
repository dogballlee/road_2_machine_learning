...
tree_data[0:int(train_num)].to_csv(output_path+'train_tree.csv', index=False,sep=' ')
tree_data[train_num:train_num+50000].to_csv(output_path+'test_tree.csv', index=False,sep=' ')
...
nn_data[train_num:train_num+50000].to_csv(output_path+'test_nn.csv', index=False, sep=' ')
